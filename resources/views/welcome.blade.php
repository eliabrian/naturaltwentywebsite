...
<body class="bg-[#F4E7D4] text-stone-800 antialiased">

    {{-- Navigation --}}
    <nav class="bg-[#6D1919] text-[#F4E7D4] py-4 shadow-lg border-b-4 border-[#BB9045]">
        <div class="max-w-6xl mx-auto px-4 flex justify-between items-center">
            <a href="{{ route('home') }}" class="text-xl font-bold font-serif tracking-wider hover:text-[#BB9045] transition">
                Natural Twenty
            </a>

            <div class="space-x-6 text-sm font-bold uppercase tracking-wide">
                <a href="{{ route('home') }}" class="text-[#BB9045] border-b-2 border-[#BB9045]">Book Room</a>
                <a href="{{ route('games.index') }}" class="hover:text-[#BB9045] transition opacity-80">Game Library</a>
            </div>
        </div>
    </nav>
                    ...
                    <div class="bg-[#F4E7D4] p-6 rounded-lg border-2 border-[#BB9045] shadow-xl relative overflow-hidden group">
                        ...
                        <div class="flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
                            ...
                            <div class="text-center md:text-left w-full md:w-auto">
                                ...
                                <div class="inline-block bg-[#6D1919] bg-opacity-10 rounded px-2 py-1">
                                    <p class="text-sm font-semibold text-[#6D1919] opacity-90">
                        ...
                        <div class="border-t border-[#BB9045] border-opacity-30 pt-3 mt-4 text-center md:text-left">
                            <p class="text-[11px] italic text-[#6D1919] opacity-80">
    ...
    <footer class="bg-[#6D1919] text-[#F4E7D4] py-8 text-center mt-auto border-t-4 border-[#BB9045]">
        <p class="font-serif font-bold text-xl tracking-widest mb-2">Natural Twenty Board Game Cafe</p>
        <p class="text-xs opacity-60 uppercase tracking-widest">&copy; {{ date('Y') }} All Rights Reserved</p>
    </footer>
